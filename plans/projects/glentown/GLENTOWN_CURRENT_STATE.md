...
Web/Windows is a distinct audit/implementation stream from Samsung/mobile recovery. Approved desktop visual and interaction decisions are now canonicalized in `GLENTOWN_WEB_WINDOWS_VISUAL_AUTHORITY.md`.
