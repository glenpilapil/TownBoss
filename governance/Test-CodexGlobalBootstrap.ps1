...
if ($violations.Count -eq 0) {
    ...
    if ($lines.Count -lt 3 -or $lines[0] -ne '# TownBoss canonical source: governance/agent-bootstrap/CODEX_GLOBAL_AGENTS.md') { $violations.Add('global AGENTS.md lacks TownBoss source provenance') }
